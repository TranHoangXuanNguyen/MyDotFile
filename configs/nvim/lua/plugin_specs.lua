...
local plugin_specs = {
  ...
  config = function()
    require("copilot").setup({
      ...
      panel = { enabled = false }, -- Tắt panel rườm rà để giữ giao diện clean
    })
  end,
},
{
  ...
  dependencies = {
    { "zbirenbaum/copilot.lua" }, -- Khung sườn Copilot bạn vừa cài
    { "nvim-lua/plenary.nvim" },  -- Thư viện lõi (bắt buộc)
  },
  build = "make tiktoken", -- Giúp mã hóa token nhanh hơn
  opts = {
    -- Thiết kế giao diện tối giản
    window = {
      layout = 'float',   -- Hiện khung chat nổi giữa màn hình
      width = 0.8,        -- Rộng 80% màn hình
      height = 0.8,       -- Cao 80% màn hình
      border = 'rounded', -- Bo góc nhẹ nhàng
    },
  },
  keys = {
    -- Phím tắt bật/tắt nhanh khung chat
    { "<leader>cc", "<cmd>CopilotChatToggle<cr>", desc = "Toggle Copilot Chat" },
    
    -- Phím tắt bôi đen code rồi hỏi nhanh
    {
      "<leader>ce",
      "<cmd>CopilotChatExplain<cr>",
      mode = "v", -- Chỉ hoạt động trong chế độ bôi đen (Visual mode)
      desc = "CopilotChat - Giải thích đoạn code",
    },
  },
},
  -- {
